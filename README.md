# image-template &nbsp; [![build badge](https://github.com/ryan-j-walker/aurora-dx/actions/workflows/build.yml/badge.svg)](https://github.com/ryan-j-walker/aurora-dx/actions/workflows/build.yml)
